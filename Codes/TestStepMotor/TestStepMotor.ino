...
int motorPin1 = 2;    // Arduino pin 8 to In 1 on the ULN2003
int motorPin2 = 3;    // Arduino pin 9 to In 2 on the ULN2003
int motorPin3 = 4;   // Arduino pin 10 to In 3 on the ULN2003
int motorPin4 = 5;   // Arduino pin 11 to In 4 on the ULN2003
